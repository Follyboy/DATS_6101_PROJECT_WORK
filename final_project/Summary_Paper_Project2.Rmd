...
## Setting the variable for checking and Splitting into Train and Test
```{r}
...
```{r}
logitModel1 <- glm(stroke~ ., data = train, family = binomial())
logitModel2 <- glm(stroke~ ., data = train, family = binomial())
logitModel3 <- glm(stroke~ ., data = train, family = binomial())
logitModel4 <- glm(stroke~ ., data = train, family = binomial())
