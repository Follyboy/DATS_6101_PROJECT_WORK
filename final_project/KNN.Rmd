...
* From our confusion matrix, we can say that the accuracy of this model is `(8838 + 0)/9029 = 0.979`, therefore we can say that this model is 97.9% accurate.
...
* According to our accuracy summary using k-values between 3 to 15 for our original data, our best accuracy model is with a k-value of 3. 

* From our confusion matrix, we can say that the accuracy of this model is `(6357 + 2597)/9029 = 0.979`, therefore we can say that this model is 97.9% accurate.
