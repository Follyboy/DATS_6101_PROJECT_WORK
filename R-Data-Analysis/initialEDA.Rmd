...
* From the plots above we see that heart disease does not really have a strong impact on stroke unlike age which has a big factor on stroke. We then see that an increase in age comes with an increase in heart disease. This means that people in the higher age bracket are more proned to heart diseases than people in the lower age bracket, this is the relation between heart disease and age.