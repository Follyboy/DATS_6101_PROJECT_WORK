...
```
 ...
 As seen above, average glucose level or diabetic level of sugar is impacting the percentage of people with strokes and not with strokes.\
...
```
 ...
 From the plots above for residence types, we notice that residence type has no effect at all on strokes. This is why we are dropping the residence column, there is no use for it in our data analysis. \
